...
struct TranscriptionRealtimeSupportTests {
    ...
    @Test func distinguishesNativeStreamingFromSlidingWindowsAndBatchModels() throws {
        ...
        let qwen3MLXINT8 = try #require(models.first { $0.name == "qwen3-asr-0.6b-mlx-int8-streaming" })
        let qwen3MLXFP16 = try #require(models.first { $0.name == "qwen3-asr-0.6b-mlx-streaming" })
        ...
        #expect(TranscriptionRealtimeSupport.mode(for: qwen3MLXINT8) == .nativeStreaming)
        #expect(TranscriptionRealtimeSupport.mode(for: qwen3MLXFP16) == .nativeStreaming)
        ...
        #expect(qwen3MLXINT8 is QwenMLXModel)
        #expect(qwen3MLXFP16 is QwenMLXModel)
        #expect(qwen3.provider == .sherpaOnnx)
        #expect(qwen3MLXINT8.provider == .qwenMlx)
        #expect(qwen3MLXFP16.provider == .qwenMlx)
    }
